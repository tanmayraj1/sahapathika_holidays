...
def parse_docx(filepath):
    ...
    for i, p in enumerate(paragraphs):
        ...
        if i == 0 and not title:
            title = p
        elif "Tour Package" in p or "Yatra" in p or "Shimla" in p:
        ...
        if match_day:
            ...
            if re.match(r'^(Inclusions|Exclusions|FAQ|Important|Package Cost|Note|Why Choose)', p, re.IGNORECASE):
                break
...
d = 'c:/Users/jhash/Downloads/Sahapathika_Holidays/new_packages'
res = []

...
const articleHtml = `
<div style="font-family:inherit;color:#3A4A44;line-height:1.75;font-size:15.5px">
  <h2 style="font-family:'Fraunces',serif;font-weight:400;font-size:32px;letter-spacing:-.02em;margin:0 0 22px;color:#16211D">From Kerala to Kashi ?" Your Sacred Journey to the City of Lord Shiva</h2>
  <div style="font-size:14px;letter-spacing:.12em;font-weight:800;color:#B5822A;margin-bottom:24px;text-transform:uppercase">Kerala → Varanasi | Air or Rail | Private Kashi Yatra</div>
  ...
  <p style="margin-bottom:24px">Travellers from Thiruvananthapuram and southern Kerala can use Thiruvananthapuram International Airport. Current schedules indicate that direct TRV?"VNS services are not consistently available, so travellers may need to use a connecting flight. Depending on the connection, total travel time can vary considerably.</p>
  ...
  <h2 style="font-family:'Fraunces',serif;font-weight:400;font-size:28px;letter-spacing:-.02em;margin:40px 0 16px;color:#16211D;border-top:1px solid rgba(22,33,29,.1);padding-top:40px">Your Varanasi Yatra ?" Planned from Kerala</h2>
  ...
  <p style="margin-bottom:16px">From there, your Kashi Yatra can be organized around your priorities ?" whether your primary purpose is:</p>
  <ul style="margin-bottom:24px;padding-left:24px;display:grid;gap:8px">
    ...
    <li>A longer Varanasi?"Ayodhya?"Prayagraj journey</li>
  </ul>
  ...
  <div style="display:grid;gap:16px;margin-bottom:48px">
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;box-shadow:0 12px 30px -14px rgba(22,33,29,.1)">
      ...
      <p style="margin:0;font-size:14.5px">Yes. Current schedules include Kochi?"Varanasi flight options, including direct services on selected days and connecting alternatives. Availability varies by date, so the exact schedule should be checked before booking.</p>
    </div>
    <div style="background:#fff;border-radius:16px;padding:24px;box-shadow:0 12px 30px -14px rgba(22,33,29,.1)">
      <div style="font-weight:800;margin-bottom:8px">4. Can I travel by train from Ernakulam to Varanasi?</div>
      <p style="margin:0;font-size:14.5px">Yes. A direct Ernakulam?"Varanasi rail service is currently listed, covering approximately 2,820 km in around 49 hours 50 minutes. Service frequency is limited, so availability should be checked for your travel date.</p>
    </div>
    <div style="background:#fff;border-radius:16px;padding:24px;box-shadow:0 12px 30px -14px rgba(22,33,29,.1)">
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;box-shadow:0 12px 30px -14px rgba(22,33,29,.1)">
      ...
      <p style="margin:0;font-size:14.5px">Yes. You can extend your Varanasi holiday into a larger Varanasi?"Ayodhya?"Prayagraj pilgrimage circuit. Chitrakoot and other destinations can also be considered depending on the number of days available.</p>
    </div>
    <div style="background:#fff;border-radius:16px;padding:24px;box-shadow:0 12px 30px -14px rgba(22,33,29,.1)">
  ...
  <div style="text-align:center;padding:48px 24px;background:#16211D;color:#FAF6EF;border-radius:20px;margin-bottom:48px">
    ...
    <div style="font-size:14px;color:rgba(251,247,238,.5)">Sahapathika Holidays ?" Live before you die.</div>
  </div>
...
const startIndex = html.indexOf('<h2 style="font-family:\\\'Fraunces\\\',serif;font-weight:400;font-size:32px;letter-spacing:-.02em;margin:0 0 22px">Day-by-day itinerary</h2>');
const endIndex = html.indexOf('<h2 style="font-family:\\\'Fraunces\\\',serif;font-weight:400;font-size:32px;letter-spacing:-.02em;margin:0 0 8px">Reviews</h2>');

if (startIndex !== -1 && endIndex !== -1) {
  const newHtml = html.substring(0, startIndex) + articleHtml + '\n          ' + html.substring(endIndex);
